                        ...
                        function updateTargetQuestion(){
                            ...
                            location.href = "/public/jotcharts/"+formID+"/radio/related-stats/"+question[0]+"/"+newID;
                        }
                        ...
                        function updateSCQuestion(){
                            var newID = document.getElementById("mcQuestionValue").value;
                            location.href = "/public/jotcharts/"+formID+"/radio/related-stats/"+newID+"/"+otherQuestion[0];
                        }
